...
%         end % value = get.Slope(obj)
        ...
        function sp = longDTI_participant(pidn, datapath)
            if nargin > 0 % Support calling with 0 arguments
                try % load parameters
                    ...
                    for timepointindex = 1: numtimepoints
                        sp.Timepoint{timepointindex} = longDTI_timepoint( fullfile( sp.Fullpath,  t(timepointindex).name) );
