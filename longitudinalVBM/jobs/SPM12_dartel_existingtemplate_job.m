%-----------------------------------------------------------------------
% Job saved on 28-Jun-2013 18:17:10 by cfg_util (rev $Rev: 4972 $)
% spm SPM - SPM12b (5298)
...
matlabbatch{1}.spm.tools.dartel.warp1.settings.param(1).template = {fullfile(dartelpath, 'Template_1.nii')};
...
matlabbatch{1}.spm.tools.dartel.warp1.settings.param(2).template = {fullfile(dartelpath, 'Template_2.nii')};
...
matlabbatch{1}.spm.tools.dartel.warp1.settings.param(3).template = {fullfile(dartelpath, 'Template_3.nii')};
...
matlabbatch{1}.spm.tools.dartel.warp1.settings.param(4).template = {fullfile(dartelpath, 'Template_4.nii')};
...
matlabbatch{1}.spm.tools.dartel.warp1.settings.param(5).template = {fullfile(dartelpath, 'Template_5.nii')};
...
matlabbatch{1}.spm.tools.dartel.warp1.settings.param(6).template = {fullfile(dartelpath, 'Template_6.nii')};
