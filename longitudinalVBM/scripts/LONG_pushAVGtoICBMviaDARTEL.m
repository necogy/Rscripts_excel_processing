...
for subject = 1:size(scans_to_process,2)
    ...
    flowfield = strrep(flowfield, 'img', 'nii'); 
    ...
    matlabbatch{1}.spm.util.defs.comp{1}.inv.comp{2}.inv.space={fullfile(spmpath,'toolbox','DARTEL','icbm152.nii')};
    ...
    matlabbatch{1}.spm.util.defs.comp{1}.inv.space = {imagetowarp};
